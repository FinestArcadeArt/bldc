...
int32_t confgenerator_serialize_appconf(uint8_t *buffer, const app_configuration *conf) {
	...
	buffer_append_float32_auto(buffer, conf->app_pas_conf.pas_pid_kp, &ind);
	buffer_append_float32_auto(buffer, conf->app_pas_conf.pas_pid_ki, &ind);
	buffer_append_float32_auto(buffer, conf->app_pas_conf.pas_pid_kd, &ind);
	buffer[ind++] = conf->app_pas_conf.pas_has_regen;
...
bool confgenerator_deserialize_appconf(const uint8_t *buffer, app_configuration *conf) {
	...
	conf->app_pas_conf.pas_pid_kp = buffer_get_float32_auto(buffer, &ind);
	conf->app_pas_conf.pas_pid_ki = buffer_get_float32_auto(buffer, &ind);
	conf->app_pas_conf.pas_pid_kd = buffer_get_float32_auto(buffer, &ind);
	conf->app_pas_conf.pas_has_regen = buffer[ind++];
...
void confgenerator_set_defaults_appconf(app_configuration *conf) {
	...
	conf->app_pas_conf.pas_has_regen = APPCONF_PAS_HAS_REGEN;
